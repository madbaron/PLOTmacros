...
t2_3.SetNDC()
t2_3.DrawLatex(.42, 0.31, 'Photon particle gun')
t2_3.DrawLatex(.42, 0.25, 'Variable cell threshold and BIB subtraction')
...
t4.DrawLatex(0.65, 0.75, 'MAIA detector concept')
...
t3.DrawLatex(0.15, 0.94, 'Background hits overlay in [-0.5, 15] ns range')
t4.DrawLatex(0.82, 0.94, '#sqrt{s} = 10 TeV')
t4.DrawLatex(0.65, 0.85, 'MAIA detector concept')
