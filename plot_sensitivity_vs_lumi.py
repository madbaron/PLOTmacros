...
parser.add_option("-i", "--inputFiles",   dest='inputFiles',
                  default="p0_hino_1T.txt,p0_hino_2T.txt,p0_wino_1T.txt,p0_wino_2T.txt", help="Comma separated input file list")
